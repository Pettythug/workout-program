...
- **Conventional Commits:** All Git commits must follow the Conventional Commits standard (e.g., eat: added routing, ix: resolved image mapping bug, docs: updated protocol).
