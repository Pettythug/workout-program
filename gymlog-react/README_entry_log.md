...
* src/components/SettingsModal.jsx -> Modal component for global application settings (adding people/locations, editing the API sync URL, and selecting the Device Owner).
